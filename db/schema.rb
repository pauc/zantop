...
ActiveRecord::Schema.define(:version => 20130107110701) do
  ...
  add_index "tags", ["slug_en"], :name => "index_tags_on_slug_en"
  add_index "tags", ["slug_es"], :name => "index_tags_on_slug_es"
